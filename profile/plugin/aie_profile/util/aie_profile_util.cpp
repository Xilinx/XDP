...
namespace xdp::aie::profile {
  ...
  std::map<std::string, std::vector<XAie_Events>> getInterfaceTileEventSets(const int hwGen)
  {
    ...
    eventSets = {
      ...
      {"read_throughput",           {XAIE_EVENT_PORT_RUNNING_0_PL,     XAIE_EVENT_PORT_RUNNING_1_PL}},
      {"write_throughput",          {XAIE_EVENT_PORT_RUNNING_0_PL,     XAIE_EVENT_PORT_RUNNING_1_PL}},
      {"ddr_throughput",            {XAIE_EVENT_PORT_RUNNING_0_PL,     XAIE_EVENT_PORT_RUNNING_1_PL,
